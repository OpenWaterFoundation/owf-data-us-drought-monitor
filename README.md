# owf-data-us-drought-monitor #

This repository contains the [Open Water Foundation (OWF)](https://openwaterfoundation.org)
dataset files for US Drought Monitor.

This repository contains workflow files to create a GeoJSON file
for the Drought Monitor current conditions.
...
---------------- above folders are recommended --------------------
        ...
        owf-data-us-drought-monitor/        This repository.
...
[US Drought Monitor](https://data.openwaterfoundation.org/country/us/usdm/drought-monitor/) dataset links.
